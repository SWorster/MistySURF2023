...
IMPORTANT: This is where I'm experimenting with Misty's head-following behavior. I've copied the automotionHalts code here so that I don't undo my progress. If I get this working, I'll copy it back in to the two finished files.
'''
